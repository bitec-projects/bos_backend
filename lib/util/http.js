...
exports.setup = function (options, req, res, next) {
    ...
    corsOpts.responseHeaders = corser.simpleResponseHeaders
        .concat(["X-Session-Token", "X-Session-Invalidated"])
        .concat(options.allowedResponseHeaders || []);
    ...
    if (options.allowCorsRootRequests) {
        corsOpts.requestHeaders.push("bbe-ssh-key");
    }
