$(document).ready(function () {
    ...
    function bindEditors() {
        if (events && editors) {
            Object.keys(editors).forEach(function (e) {
                ...
                editors[e].getSession().on("change", function () {
                    trackUpdate(e, editors[e]);
                });
    ...
    function loadEvents() {
        ...
        Context.events.forEach(function (e) {
            ...
            bbe("__resources").get(Context.resourceId + "/" + fileName, function (res, err) {
    ...
    function update(name, editor) {
        ...
        bbe("__resources").put(Context.resourceId + "/" + fileName, put, function (res, err) {
            if (err) {
                return ui.error("Error saving event", err.message).effect("slide");
            }
